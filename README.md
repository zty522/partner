...
|-----------|----------|------|------|
| zty | 代码修改 | 项目创建者 | - |
| zzd | 问题发现 | Windows gui创建不了实例 | 已修复 |
| yx | 问题发现 | 实例启动失败，查明原因是Windows GUI 不会用 wsl.exe 启动 WSL 端的实例，而是直接调 Windows Python，导致 PID 文件争夺、锁冲突、路径不兼容三重故障。 | 已修复 |
...
<img src="assets/微信群.jpg" width="240" alt="微信群二维码" /> <img src="assets/qq群.jpg" width="240" alt="QQ群二维码" />
