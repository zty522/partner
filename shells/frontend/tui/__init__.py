...
from partner.state.config import resolve_partner_config_path, workspace_has_partner_config
from partner.cli.common import (
...
def _show_instances():
    try:
        from partner.core.manager import print_instance_list
        print()
        print_instance_list()
        print()
    except Exception as e:
...
def _wait_for_response(workspace: str):
    ...
    qq_hist_paths = []
    try:
        from partner.workspace.workspace_layout import history_paths as _hp
    ...
    dialog_hist_paths = []
    try:
        from partner.workspace.workspace_layout import history_paths as _hp2
