...
class PartnerApp:
    ...
    def _collect_dashboard_snapshot(self):
        ...
        from partner.adapters.adapter import HermesAdapter as _HA
    ...
    def _send_chat(self, event=None):
        ...
        def do_reply():
            try:
                ...
                from partner.knowledge.knowledge import KnowledgeBase as _K
                from partner.tasks.task_queue import TaskQueue as _TQ
                from partner.state.state import StateManager as _SM
                from partner.dialogue.conversation import ConversationEngine as _CE
                from partner.adapters.adapter import create_adapter as _ca
