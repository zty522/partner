...
from partner.workspace.workspace_migration import migrate_partner_workspace
...
def find_workspace() -> Optional[str]:
    from partner.state.setup import find_workspace as _fw
    return _fw()
...
"""
    ...
    def save_instance_partner_agent_config(self, instance_dir: str, agent_cfg: dict) -> tuple[bool, str]:
        ...
        try:
            from partner.state.config import load_partner_config_data, save_partner_config_data
    ...
    def instance_ollama_snapshot(self, instance_id: str, instance_dir: str) -> dict:
        ...
        lite_status = {}
        try:
            from partner.monitoring.runtime_monitor import summarize_agent_runs
    ...
    def desired_hermes_runtime_model_config(self, data: dict) -> dict:
        try:
            from partner.adapters.agent_config_sync import PROVIDER_DEFAULT_BASE_URLS
        except Exception:
    ...
    def sync_hermes_runtime_model_config(self, data: dict) -> tuple[bool, str]:
        ...
        try:
            from partner.adapters.agent_config_sync import apply_hermes_model_config
