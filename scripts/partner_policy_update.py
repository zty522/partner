#!/usr/bin/env python3
"""Build offline policy learning trajectories and a non-production candidate policy."""
...
def main() -> int:
    ...
    result = run_offline_policy_learning_update(args.workspace, args.campaign_id)
