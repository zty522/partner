...
from partner.qq_bot.qq_official_bot import QQQfficialBot, QQMessage, QQMessageType, QQBotInfo
...
from partner.outbound_policy import THINKING_NOTICE, UNAVAILABLE_NOTICE
from partner.config import (
    apply_runtime_agent_defaults,
    load_partner_config_data,
    save_partner_config_data,
)
from partner.interaction_orchestrator import InteractionOrchestrator
from partner.user_text_safety import has_internal_diff, strip_internal_diff
...
class QQQfficialBridge:
    ...
    def _handle_message(self, msg: QQMessage):
        ...
        try:
            ...
            from ..mind.executor import enqueue_user_message
