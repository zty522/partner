...
# self_evolve_annotation: candidate_id=repair_to_pr_f3a0087a9efc332b failure_class=planning.semantic_preflight intervention=mechanism_specific_bounded_repair
    return record
