"""Synthetic research_contradiction fixture (M3 / Domain "research_reporting") — v1.
...
FAMILY = "research_contradiction"
DOMAIN = "research_reporting"


STAGES = [{'stage': 1, 'name': 'load_data', 'function': 'load_data', 'input': 'input.csv', 'output': 'loaded.json', 'expected': {'row_count': 12}}, {'stage': 2, 'name': 'detect_contradictions', 'function': 'detect_contradictions', 'input': 'loaded.json', 'output': 'contradictions.json', 'expected': {'fields': ['n_contradictions']}}, {'stage': 3, 'name': 'report', 'function': 'report', 'input': 'contradictions.json', 'output': 'report.json', 'expected': {'fields': ['summary']}}]
...
TASK_DEFINITION = {
    "task_id": "rep_contra_v1",
    "family": FAMILY,
    "domain": DOMAIN,
    "schema_version": "benchmark/v1",
    "inputs": ['fixtures/research_contradiction/input.csv', 'fixtures/research_contradiction/README.md'],
    "initial_state": {"working_dir": "episodes/rep_contra_v1/workspace"},
    "stages": STAGES,
    "success_criteria": ['loaded.json matches reference', 'contradictions.json matches reference', 'report.json matches reference'],
    "annotations": [{
        "annotation_id": "ann_rep_contra_v1_01",
        "task_id": "rep_contra_v1",
        "label": "needs_human",
        "evidence_refs": ['fixtures/research_contradiction/input.csv', 'fixtures/research_contradiction/README.md'],
