"""Synthetic research_evidence fixture (M3 / Domain "research_reporting") — v1.
...
STAGES = [{'stage': 1, 'name': 'load_data', 'function': 'load_data', 'input': 'input.csv', 'output': 'loaded.json', 'expected': {'row_count': 12}}, {'stage': 2, 'name': 'compose_pack', 'function': 'compose_pack', 'input': 'loaded.json', 'output': 'pack.md', 'expected': {'contains_citation': True}}, {'stage': 3, 'name': 'report', 'function': 'report', 'input': 'pack.md', 'output': 'report.json', 'expected': {'fields': ['evidence_status']}}]
...
TASK_DEFINITION = {
    "task_id": "rep_evidence_v1",
    "family": FAMILY,
    "domain": DOMAIN,
    "schema_version": "benchmark/v1",
    "inputs": ['fixtures/research_evidence/input.csv', 'fixtures/research_evidence/README.md'],
    "initial_state": {"working_dir": "episodes/rep_evidence_v1/workspace"},
    "stages": STAGES,
    "success_criteria": ['loaded.json matches reference', 'pack.md matches reference', 'report.json matches reference'],
    "annotations": [{
        "annotation_id": "ann_rep_evidence_v1_01",
        "task_id": "rep_evidence_v1",
        "label": "needs_human",
        "evidence_refs": ['fixtures/research_evidence/input.csv', 'fixtures/research_evidence/README.md'],
