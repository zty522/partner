"""Synthetic scientific_drift fixture (M3 / Domain "scientific_analysis_planning") — v1.
...
FAMILY = "scientific_drift"
DOMAIN = "scientific_analysis_planning"


STAGES = [{'stage': 1, 'name': 'load_data', 'function': 'load_data', 'input': 'input.csv', 'output': 'loaded.json', 'expected': {'row_count': 12}}, {'stage': 2, 'name': 'drift_check', 'function': 'drift_check', 'input': 'loaded.json', 'output': 'drift.json', 'expected': {'fields': ['p_value']}}, {'stage': 3, 'name': 'report', 'function': 'report', 'input': 'drift.json', 'output': 'report.json', 'expected': {'fields': ['drift_detected']}}]
...
TASK_DEFINITION = {
    "task_id": "sci_drift_v1",
    "family": FAMILY,
    "domain": DOMAIN,
    "schema_version": "benchmark/v1",
    "inputs": ['fixtures/scientific_drift/input.csv', 'fixtures/scientific_drift/README.md'],
    "initial_state": {"working_dir": "episodes/sci_drift_v1/workspace"},
    "stages": STAGES,
    "success_criteria": ['loaded.json matches reference', 'drift.json matches reference', 'report.json matches reference'],
    "annotations": [{
        "annotation_id": "ann_sci_drift_v1_01",
        "task_id": "sci_drift_v1",
        "label": "needs_human",
        "evidence_refs": ['fixtures/scientific_drift/input.csv', 'fixtures/scientific_drift/README.md'],
