"""Synthetic data_pipeline_log fixture (M3 / Domain "software_data_pipeline") — v1.
...
FAMILY = "data_pipeline_log"
DOMAIN = "software_data_pipeline"


STAGES = [{'stage': 1, 'name': 'parse_logs', 'function': 'parse_logs', 'input': 'input.csv', 'output': 'events.jsonl', 'expected': {'min_rows': 6}}, {'stage': 2, 'name': 'sessionize', 'function': 'sessionize', 'input': 'events.jsonl', 'output': 'sessions.csv', 'expected': {'row_count': 1}}, {'stage': 3, 'name': 'report', 'function': 'report', 'input': 'sessions.csv', 'output': 'report.json', 'expected': {'fields': ['error_rate']}}]
...
TASK_DEFINITION = {
    ...
    "inputs": ['fixtures/data_pipeline_log/input.csv', 'fixtures/data_pipeline_log/README.md'],
    "initial_state": {"working_dir": "episodes/sw_log_v1/workspace"},
    "stages": STAGES,
    "success_criteria": ['events.jsonl matches reference', 'sessions.csv matches reference', 'report.json matches reference'],
    "annotations": [{
        "annotation_id": "ann_sw_log_v1_01",
        "task_id": "sw_log_v1",
        "label": "needs_human",
        "evidence_refs": ['fixtures/data_pipeline_log/input.csv', 'fixtures/data_pipeline_log/README.md'],
