"""Synthetic scientific_replication fixture (M3 / Domain "scientific_analysis_planning") — v1.
...
FAMILY = "scientific_replication"
DOMAIN = "scientific_analysis_planning"


STAGES = [{'stage': 1, 'name': 'load_data', 'function': 'load_data', 'input': 'input.csv', 'output': 'loaded.json', 'expected': {'row_count': 12}}, {'stage': 2, 'name': 'reconcile', 'function': 'reconcile', 'input': 'loaded.json', 'output': 'reconciled.json', 'expected': {'fields': ['decision']}}, {'stage': 3, 'name': 'report', 'function': 'report', 'input': 'reconciled.json', 'output': 'report.json', 'expected': {'fields': ['replication_status']}}]
...
TASK_DEFINITION = {
    ...
    "inputs": ['fixtures/scientific_replication/input.csv', 'fixtures/scientific_replication/README.md'],
    "initial_state": {"working_dir": "episodes/sci_repl_v1/workspace"},
    "stages": STAGES,
    "success_criteria": ['loaded.json matches reference', 'reconciled.json matches reference', 'report.json matches reference'],
    "annotations": [{
        "annotation_id": "ann_sci_repl_v1_01",
        "task_id": "sci_repl_v1",
        "label": "needs_human",
        "evidence_refs": ['fixtures/scientific_replication/input.csv', 'fixtures/scientific_replication/README.md'],
