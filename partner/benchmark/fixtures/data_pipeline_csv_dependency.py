"""Synthetic data_pipeline_csv_dependency fixture (M3 / Domain "software_data_pipeline") — v1.
...
FAMILY = "data_pipeline_csv_dependency"
...
TASK_DEFINITION = {
    ...
    "inputs": ['fixtures/data_pipeline_csv_dependency/input.csv', 'fixtures/data_pipeline_csv_dependency/README.md'],
    "initial_state": {"working_dir": "episodes/sw_dep_v1/workspace"},
    "stages": STAGES,
    "success_criteria": ['filtered.jsonl matches reference', 'aggregation.csv matches reference', 'report.json matches reference'],
    "annotations": [{
        "annotation_id": "ann_sw_dep_v1_01",
        "task_id": "sw_dep_v1",
        "label": "needs_human",
        "evidence_refs": ['fixtures/data_pipeline_csv_dependency/input.csv', 'fixtures/data_pipeline_csv_dependency/README.md'],
