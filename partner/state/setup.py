...
from ..monitoring.instance_root import resolve_global_config_path, resolve_instance_workspace, resolve_partner_root
...
from partner.workspace.workspace_manager import run_daily_maintenance
...
def interactive_setup(quick: bool = False):
    ...
    # ── Step 5b: WSL Bridge ──
    from partner.adapters.wsl_bridge import is_wsl, get_windows_drives, get_windows_user_dirs
    ...
    if is_wsl() and not quick:
        ...
        from partner.adapters.wsl_bridge import get_platform
        plat = get_platform()
