...
Usage:
    python -m partner.desktop_gui.launcher
    python -m partner.desktop_gui.launcher --workspace /path/to/workspace
...
def find_workspace() -> str | None:
    ...
    try:
        from partner.setup import find_workspace as _find_ws
        return _find_ws()
    except ImportError:
        pass
